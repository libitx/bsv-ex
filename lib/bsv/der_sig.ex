...
#  def get_public_key(sig) do
#    psig = parse(sig)
#    i = Base.encode16(<< psig.type >>) |> String.to_integer
#    e = :binary.decode_unsigned(sig)
#    r = :binary.decode_unsigned(psig.r)
#    s = :binary.decode_unsigned(psig.s)
#
#    isYOdd = i &&& 1
#    isSecondKey = i >>> 1
#
#    x = if isSecondKey > 0, then: r + @secp256k1.n, else: r
#    rr = 
#
#
#  end
  ...
  defp low_s_num(s) when s > @low_s_max, do: @secp256k1.n - s
