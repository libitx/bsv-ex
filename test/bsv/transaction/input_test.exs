defmodule BSV.Transaction.InputTest do
  ...
  setup_all do
    %{
      ...
      input: %BSV.Transaction.Input{
        ...
        sequence: 4294967295,
        txid: "f1a8160761ead3e33801b0791a3f02c7984f76436ae8edac5bb43b437621b27b"
      }
    }
  end
  ...
  describe "BSV.Transaction.Input.parse/2" do
    test "must parse single input", ctx do
      ...
      assert input.txid == "f1a8160761ead3e33801b0791a3f02c7984f76436ae8edac5bb43b437621b27b"
